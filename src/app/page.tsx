          ...
          <div className="absolute mx-auto left-0 right-0 h-full flex items-center justify-center">
            <div className="relative w-full pb-[8vh]">
              ...
              <div className="rounded-full bg-white h-[5rem] relative w-[80%] mx-auto h-[5vw] mt-[1vh]">
                ...
                <div className="absolute left-[18vw] top-[1vw] flex gap-[1vw]">
                ...
                >
                  ...
                  <div className="mt-[0.2vw]">
                    ...
                    <div className="text-[1vw] font-bold text-black">All</div>
                  </div>
                </div>
                <div className="absolute bg-blue-300 text-white text-[1vw] font-bold right-[1%] rounded-full top-0 bottom-0 h-[4vw] my-auto w-[8vw] flex items-center justify-center cursor-pointer text-center">
                  Explore
                </div>
              </div>
            </div>
